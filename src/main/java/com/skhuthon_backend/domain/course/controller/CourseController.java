...
import com.skhuthon_backend.domain.course.dto.CourseCandidateRequest;
...
public class CourseController {
    ...
    public ResponseEntity<List<CourseOfferingCandidateResponse>> findCandidateOfferings(
            @Valid @RequestBody CourseCandidateRequest request
    ) {
        List<CourseOfferingCandidateResponse> response = timetableEngineService.findCandidateOfferings(
